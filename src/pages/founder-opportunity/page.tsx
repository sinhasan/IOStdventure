...
const RESPONSE_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'I would like TD Venture to coordinate a first meeting with this investor.',
    emphasis: 'primary',
  },
  {
  ...
  },
  {
    ...
    description:
      'Pause TD Venture Deal Desk outreach for 30 days. New investor invitations may resume automatically after the pause expires.',
    emphasis: 'neutral',
  },
  {
    ...
    description:
      'Do not send me further Deal Desk founder outreach.',
    emphasis: 'danger',
  },
];
...
export default function FounderOpportunityPage() {
  ...
  const [submitting, setSubmitting] =
    useState<FounderResponse | null>(null);
    ...
    async function loadInvitation() {
      ...
      try {
        const res = await fetch(
          '/api/public/founder-opportunity-invitations/review',
          {
            method: 'POST',
            headers: {
  ...
  async function submitResponse(response: FounderResponse) {
    ...
    try {
      const res = await fetch(
        '/api/public/founder-opportunity-invitations/respond',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const investor = review?.opportunity?.investor;
                ...
                <div className="px-7 py-8 sm:px-10">
                  ...
                  <dl className="grid gap-6 sm:grid-cols-3">
                    ...
                    <div>
                      ...
                      <dd className="mt-2 text-base font-medium text-slate-900">
                        {investor?.identity || 'Protected Investor'}
                      </dd>
                    </div>
